...
public class StudentGroup implements StudentArrayOperation {
	...
	@Override
	public Student getStudent(int dob) {
		// Add your implementation here
		if(dob<0 || dob>=students.length){
			throw new IllegalArgumentException();
		}
		else{
		return students[dob];
	...
	@Override
	public void setStudent(Student student, int lod) {
		// Add your implementation here
		//if(student==null || lod<0 || lod>=students.length)
		//	throw new IllegalArgumentException();
		//else{
			//students[lod]=student;
...
Student[] temp = new Student[this.getStudents().length+1];
	...
	@Override
	public void remove(int kok) {
		int c;
		// Add your implementation here
		if(kok<0 || kok>=students.length)
		{throw new IllegalArgumentException();}
		Student[] temp = new Student[this.students.length-1]; 
		
		 for(int i = 0; i < this.students.length; i++)
			 if(i != kok) temp[c++] = this.students[i];
		 this.students = temp;
